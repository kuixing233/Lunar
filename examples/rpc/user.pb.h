...
class LoginResponse PROTOBUF_FINAL :
 ...
 public:
  ...
  void set_test_name_1(const std::string& value);
  void set_test_name_1(std::string&& value);
  void set_test_name_1(const char* value);
  void set_test_name_1(const char* value, size_t size);
  std::string* mutable_test_name_1();
  std::string* release_test_name_1();
  void set_allocated_test_name_1(std::string* test_name_1);
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_test_name_1();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_test_name_1(
      std::string* test_name_1);
  private:
  const std::string& _internal_test_name_1() const;
  void _internal_set_test_name_1(const std::string& value);
  ...
  void set_test_name_4(const std::string& value);
  void set_test_name_4(std::string&& value);
  void set_test_name_4(const char* value);
  void set_test_name_4(const void* value, size_t size);
  std::string* mutable_test_name_4();
  std::string* release_test_name_4();
  void set_allocated_test_name_4(std::string* test_name_4);
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_test_name_4();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_test_name_4(
      std::string* test_name_4);
  private:
  const std::string& _internal_test_name_4() const;
  void _internal_set_test_name_4(const std::string& value);
...
inline void LoginResponse::clear_test_name_1() {
  test_name_1_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline void LoginResponse::set_test_name_1(const std::string& value) {
  _internal_set_test_name_1(value);
...
inline std::string* LoginResponse::mutable_test_name_1() {
  ...
  return _internal_mutable_test_name_1();
}
inline const std::string& LoginResponse::_internal_test_name_1() const {
  return test_name_1_.Get();
}
inline void LoginResponse::_internal_set_test_name_1(const std::string& value) {
  
  test_name_1_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void LoginResponse::set_test_name_1(std::string&& value) {
  
  test_name_1_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:fixbug.LoginResponse.test_name_1)
}
inline void LoginResponse::set_test_name_1(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  test_name_1_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:fixbug.LoginResponse.test_name_1)
}
inline void LoginResponse::set_test_name_1(const char* value,
    size_t size) {
  
  test_name_1_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:fixbug.LoginResponse.test_name_1)
}
inline std::string* LoginResponse::_internal_mutable_test_name_1() {
  
  return test_name_1_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* LoginResponse::release_test_name_1() {
  // @@protoc_insertion_point(field_release:fixbug.LoginResponse.test_name_1)
  return test_name_1_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void LoginResponse::set_allocated_test_name_1(std::string* test_name_1) {
  ...
  test_name_1_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), test_name_1,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:fixbug.LoginResponse.test_name_1)
}
inline std::string* LoginResponse::unsafe_arena_release_test_name_1() {
  // @@protoc_insertion_point(field_unsafe_arena_release:fixbug.LoginResponse.test_name_1)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return test_name_1_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void LoginResponse::unsafe_arena_set_allocated_test_name_1(
    std::string* test_name_1) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (test_name_1 != nullptr) {
  ...
  test_name_1_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      test_name_1, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.LoginResponse.test_name_1)
}

// bytes test_name_4 = 4;
inline void LoginResponse::clear_test_name_4() {
  test_name_4_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline void LoginResponse::set_test_name_4(const std::string& value) {
  _internal_set_test_name_4(value);
...
inline std::string* LoginResponse::mutable_test_name_4() {
  ...
  return _internal_mutable_test_name_4();
}
inline const std::string& LoginResponse::_internal_test_name_4() const {
  return test_name_4_.Get();
}
inline void LoginResponse::_internal_set_test_name_4(const std::string& value) {
  
  test_name_4_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void LoginResponse::set_test_name_4(std::string&& value) {
  
  test_name_4_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:fixbug.LoginResponse.test_name_4)
}
inline void LoginResponse::set_test_name_4(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  test_name_4_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:fixbug.LoginResponse.test_name_4)
}
inline void LoginResponse::set_test_name_4(const void* value,
    size_t size) {
  
  test_name_4_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:fixbug.LoginResponse.test_name_4)
}
inline std::string* LoginResponse::_internal_mutable_test_name_4() {
  
  return test_name_4_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* LoginResponse::release_test_name_4() {
  // @@protoc_insertion_point(field_release:fixbug.LoginResponse.test_name_4)
  return test_name_4_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void LoginResponse::set_allocated_test_name_4(std::string* test_name_4) {
  ...
  test_name_4_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), test_name_4,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:fixbug.LoginResponse.test_name_4)
}
inline std::string* LoginResponse::unsafe_arena_release_test_name_4() {
  // @@protoc_insertion_point(field_unsafe_arena_release:fixbug.LoginResponse.test_name_4)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return test_name_4_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void LoginResponse::unsafe_arena_set_allocated_test_name_4(
    std::string* test_name_4) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (test_name_4 != nullptr) {
  ...
  test_name_4_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      test_name_4, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.LoginResponse.test_name_4)
}
