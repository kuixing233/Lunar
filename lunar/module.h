...
//     virtual bool handleRequest(lunar::Message::ptr req
//                                ,lunar::Message::ptr rsp
//                                ,lunar::Stream::ptr stream);
//     virtual bool handleNotify(lunar::Message::ptr notify
//                               ,lunar::Stream::ptr stream);
...
//     virtual bool handleRockRequest(lunar::RockRequest::ptr request
//                         ,lunar::RockResponse::ptr response
//                         ,lunar::RockStream::ptr stream) = 0;
//     virtual bool handleRockNotify(lunar::RockNotify::ptr notify
//                         ,lunar::RockStream::ptr stream) = 0;
