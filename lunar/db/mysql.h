#ifndef __LUNAR_DB_MYSQL_H__
#define __LUNAR_DB_MYSQL_H__
...
public:
    ...
    // 准备SQL语句
    lunar::IStmt::ptr prepare(const std::string &sql) override;
...
typedef lunar::Singleton<MySQLManager> MySQLMgr;
