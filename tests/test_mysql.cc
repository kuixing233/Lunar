...
void run()
{
    do
    {
        ...
        // lunar::MySQLStmt::ptr stmt = lunar::MySQLStmt::Create(mysql, "update user set update_time = ? where id = 1");
        ...
        // stmt->bind(0, a);
        // auto res = std::dynamic_pointer_cast<lunar::MySQLStmtRes>(stmt->query());
